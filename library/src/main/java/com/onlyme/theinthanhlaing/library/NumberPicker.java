package com.onlyme.theinthanhlaing.library;
...
import com.onlyme.theinthanhlaing.library.Listener.ActionListener;
import com.onlyme.theinthanhlaing.library.Listener.DefaultLimitExceededListener;
import com.onlyme.theinthanhlaing.library.Listener.DefaultOnEditorActionListener;
import com.onlyme.theinthanhlaing.library.Listener.DefaultOnFocusChangeListener;
import com.onlyme.theinthanhlaing.library.Listener.DefaultValueChangedListner;
...
public class NumberPicker extends LinearLayoutCompat {
    ...
    private void initialize(Context context, AttributeSet attrs){
        ...
        this.incrementButton.setOnClickListener(new ActionListener(this, ActionEnum.INCREMENT,this.displayEditText));
        this.decrementButton.setOnClickListener(new ActionListener(this,ActionEnum.DECREMENT,this.displayEditText));

        this.setLimitExceededListener(new DefaultLimitExceededListener());
        this.setValueChangedListener(new DefaultValueChangedListner());
